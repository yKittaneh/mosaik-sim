...
def build_sim_setup( setup_dir, out_stream = print ):
    ...
    try:
        ...
        spring_jar = config_data_orch['spring_jar'].strip() # <-- Yazan
        ...
        spring_jar_path = pathlib.Path( setup_dir, spring_jar ).resolve( strict = True ) # <-- Yazan
        ...
        shutil.copy( spring_jar_path, orch_context_dir ) # <-- Yazan
        ...
        cmd = [
            ...
            '--build-arg', 'SPRING_JAR={}'.format( spring_jar ), # <-- Yazan
