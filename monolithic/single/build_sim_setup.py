...
def build_sim_setup(setup_dir, out_stream=print):
    ...
    try:
        ...
        server_jar = config_data_orch['server_jar'].strip()  # <-- Yazan
        ...
        server_jar_path = pathlib.Path(setup_dir, server_jar).resolve(strict=True)  # <-- Yazan
        ...
        cmd = [
            ...
            '--build-arg', 'SERVER_JAR={}'.format(server_jar),  # <-- Yazan
